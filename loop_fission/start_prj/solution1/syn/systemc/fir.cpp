...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_acc_1_fu_193_p2);
    sensitive << ( tmp_6_reg_244 );
    sensitive << ( acc_reg_119 );
    ...
    SC_METHOD(thread_i_1_cast_fu_165_p1);
    sensitive << ( i_1_reg_132 );

    SC_METHOD(thread_i_2_fu_149_p2);
    sensitive << ( i_reg_107 );

    SC_METHOD(thread_i_3_fu_183_p2);
    sensitive << ( i_1_reg_132 );
    ...
    SC_METHOD(thread_tmp_1_fu_169_p3);
    sensitive << ( i_1_reg_132 );

    SC_METHOD(thread_tmp_2_fu_155_p1);
    sensitive << ( i_2_fu_149_p2 );

    SC_METHOD(thread_tmp_3_fu_160_p1);
    sensitive << ( i_reg_107 );

    SC_METHOD(thread_tmp_5_fu_177_p1);
    sensitive << ( i_1_cast_fu_165_p1 );

    SC_METHOD(thread_tmp_6_fu_189_p2);
    sensitive << ( shift_reg_load_1_reg_234 );
    sensitive << ( c_load_reg_239 );
    ...
    sc_trace(mVcdFile, i_2_fu_149_p2, "i_2_fu_149_p2");
    sc_trace(mVcdFile, i_2_reg_206, "i_2_reg_206");
    sc_trace(mVcdFile, ap_CS_fsm_state2, "ap_CS_fsm_state2");
    sc_trace(mVcdFile, tmp_fu_143_p2, "tmp_fu_143_p2");
    sc_trace(mVcdFile, ap_CS_fsm_state4, "ap_CS_fsm_state4");
    sc_trace(mVcdFile, tmp_1_fu_169_p3, "tmp_1_fu_169_p3");
    sc_trace(mVcdFile, i_3_fu_183_p2, "i_3_fu_183_p2");
    sc_trace(mVcdFile, i_3_reg_229, "i_3_reg_229");
    sc_trace(mVcdFile, shift_reg_load_1_reg_234, "shift_reg_load_1_reg_234");
    sc_trace(mVcdFile, ap_CS_fsm_state5, "ap_CS_fsm_state5");
    sc_trace(mVcdFile, c_load_reg_239, "c_load_reg_239");
    sc_trace(mVcdFile, tmp_6_fu_189_p2, "tmp_6_fu_189_p2");
    sc_trace(mVcdFile, tmp_6_reg_244, "tmp_6_reg_244");
    sc_trace(mVcdFile, ap_CS_fsm_state6, "ap_CS_fsm_state6");
    sc_trace(mVcdFile, acc_1_fu_193_p2, "acc_1_fu_193_p2");
    sc_trace(mVcdFile, ap_CS_fsm_state7, "ap_CS_fsm_state7");
    sc_trace(mVcdFile, i_reg_107, "i_reg_107");
    sc_trace(mVcdFile, ap_CS_fsm_state3, "ap_CS_fsm_state3");
    sc_trace(mVcdFile, acc_reg_119, "acc_reg_119");
    sc_trace(mVcdFile, i_1_reg_132, "i_1_reg_132");
    ...
    sc_trace(mVcdFile, i_1_cast_fu_165_p1, "i_1_cast_fu_165_p1");
...
void fir::thread_ap_clk_no_reset_() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state7.read())) {
        acc_reg_119 = acc_1_fu_193_p2.read();
    } else if ((esl_seteq<1,1,1>(tmp_fu_143_p2.read(), ap_const_lv1_1) && 
    ...
    if ((esl_seteq<1,1,1>(tmp_fu_143_p2.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
        i_2_reg_206 = i_2_fu_149_p2.read();
    }
    if ((esl_seteq<1,1,1>(tmp_1_fu_169_p3.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()))) {
        i_3_reg_229 = i_3_fu_183_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
        tmp_6_reg_244 = tmp_6_fu_189_p2.read();
    }
}

void fir::thread_acc_1_fu_193_p2() {
    acc_1_fu_193_p2 = (!tmp_6_reg_244.read().is_01() || !acc_reg_119.read().is_01())? sc_lv<32>(): (sc_biguint<32>(tmp_6_reg_244.read()) + sc_biguint<32>(acc_reg_119.read()));
}
...
void fir::thread_ap_done() {
    if ((esl_seteq<1,1,1>(tmp_1_fu_169_p3.read(), ap_const_lv1_1) && 
...
void fir::thread_i_1_cast_fu_165_p1() {
    i_1_cast_fu_165_p1 = esl_sext<32,5>(i_1_reg_132.read());
}

void fir::thread_i_2_fu_149_p2() {
    i_2_fu_149_p2 = (!i_reg_107.read().is_01() || !ap_const_lv4_F.is_01())? sc_lv<4>(): (sc_biguint<4>(i_reg_107.read()) + sc_bigint<4>(ap_const_lv4_F));
}

void fir::thread_i_3_fu_183_p2() {
    i_3_fu_183_p2 = (!i_1_reg_132.read().is_01() || !ap_const_lv5_1F.is_01())? sc_lv<5>(): (sc_bigint<5>(i_1_reg_132.read()) + sc_bigint<5>(ap_const_lv5_1F));
}

void fir::thread_shift_reg_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        shift_reg_address0 =  (sc_lv<4>) (tmp_5_fu_177_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        shift_reg_address0 =  (sc_lv<4>) (tmp_3_fu_160_p1.read());
    } else if ((esl_seteq<1,1,1>(tmp_fu_143_p2.read(), ap_const_lv1_1) && 
                esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
        shift_reg_address0 = ap_const_lv4_0;
    } else if ((esl_seteq<1,1,1>(tmp_fu_143_p2.read(), ap_const_lv1_0) && 
                esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
        shift_reg_address0 =  (sc_lv<4>) (tmp_2_fu_155_p1.read());
    } else {
...
void fir::thread_tmp_1_fu_169_p3() {
    tmp_1_fu_169_p3 = i_1_reg_132.read().range(4, 4);
}

void fir::thread_tmp_2_fu_155_p1() {
    tmp_2_fu_155_p1 = esl_zext<64,4>(i_2_fu_149_p2.read());
}

void fir::thread_tmp_3_fu_160_p1() {
    tmp_3_fu_160_p1 = esl_zext<64,4>(i_reg_107.read());
}

void fir::thread_tmp_5_fu_177_p1() {
    tmp_5_fu_177_p1 = esl_zext<64,32>(i_1_cast_fu_165_p1.read());
}

void fir::thread_tmp_6_fu_189_p2() {
    tmp_6_fu_189_p2 = (!shift_reg_load_1_reg_234.read().is_01() || !c_load_reg_239.read().is_01())? sc_lv<32>(): sc_bigint<32>(shift_reg_load_1_reg_234.read()) * sc_bigint<32>(c_load_reg_239.read());
}

void fir::thread_tmp_fu_143_p2() {
    tmp_fu_143_p2 = (!i_reg_107.read().is_01() || !ap_const_lv4_0.is_01())? sc_lv<1>(): sc_lv<1>(i_reg_107.read() == ap_const_lv4_0);
}
...
void fir::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 4 : 
            ...
            break;
        case 8 : 
            if ((esl_seteq<1,1,1>(tmp_1_fu_169_p3.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else {
