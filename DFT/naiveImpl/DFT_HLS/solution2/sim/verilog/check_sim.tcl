...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.dft.autotvin_sample_real.dat"
         "c.dft.autotvin_sample_imag.dat"
         "c.dft.autotvout_sample_real.dat"
         "c.dft.autotvout_sample_imag.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.dft.autotvout_sample_real.dat"
         "rtl.dft.autotvout_sample_imag.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
