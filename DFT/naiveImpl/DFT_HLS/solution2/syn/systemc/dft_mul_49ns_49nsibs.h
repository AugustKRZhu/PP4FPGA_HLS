...
#ifndef __dft_mul_49ns_49nsibs__HH__
#define __dft_mul_49ns_49nsibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dft_mul_49ns_49nsibs) {
    ...
    SC_CTOR(dft_mul_49ns_49nsibs):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
