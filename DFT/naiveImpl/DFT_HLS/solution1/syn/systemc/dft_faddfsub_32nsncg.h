...
#ifndef __dft_faddfsub_32nsncg__HH__
#define __dft_faddfsub_32nsncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dft_faddfsub_32nsncg) {
    ...
    SC_CTOR(dft_faddfsub_32nsncg):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
