...
#ifndef __dft_mul_42ns_33nslbW__HH__
#define __dft_mul_42ns_33nslbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dft_mul_42ns_33nslbW) {
    ...
    SC_CTOR(dft_mul_42ns_33nslbW):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
