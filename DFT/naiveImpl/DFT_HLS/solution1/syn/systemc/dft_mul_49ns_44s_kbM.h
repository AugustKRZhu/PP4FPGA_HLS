...
#ifndef __dft_mul_49ns_44s_kbM__HH__
#define __dft_mul_49ns_44s_kbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dft_mul_49ns_44s_kbM) {
    ...
    SC_CTOR(dft_mul_49ns_44s_kbM):  ACMP_mul_us_U ("ACMP_mul_us_U") {
