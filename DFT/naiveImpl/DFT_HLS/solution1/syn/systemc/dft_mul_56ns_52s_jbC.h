...
#ifndef __dft_mul_56ns_52s_jbC__HH__
#define __dft_mul_56ns_52s_jbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dft_mul_56ns_52s_jbC) {
    ...
    SC_CTOR(dft_mul_56ns_52s_jbC):  ACMP_mul_us_U ("ACMP_mul_us_U") {
