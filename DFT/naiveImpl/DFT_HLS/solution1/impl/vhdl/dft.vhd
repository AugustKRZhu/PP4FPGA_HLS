...
architecture behav of dft is 
    ...
    "dft,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xa7a12tcsg325-1q,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.573000,HLS_SYN_LAT=4853762,HLS_SYN_TPT=none,HLS_SYN_MEM=18,HLS_SYN_DSP=199,HLS_SYN_FF=12531,HLS_SYN_LUT=18213,HLS_VERSION=2018_2}";
