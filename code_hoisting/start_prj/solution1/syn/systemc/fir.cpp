...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_acc_1_fu_145_p2);
    ...
    SC_METHOD(thread_i_1_fu_124_p2);
    sensitive << ( i_reg_103 );

    SC_METHOD(thread_shift_reg_address0);
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( tmp_3_reg_185 );
    ...
    sensitive << ( i_1_fu_124_p2 );

    SC_METHOD(thread_tmp_3_fu_135_p1);
    sensitive << ( i_reg_103 );

    SC_METHOD(thread_tmp_4_fu_140_p2);
    sensitive << ( reg_114 );
    sensitive << ( shift_reg_load_reg_195 );

    SC_METHOD(thread_tmp_6_fu_150_p1);
    sensitive << ( x );
    sensitive << ( ap_CS_fsm_state7 );

    SC_METHOD(thread_tmp_6_fu_150_p2);
    sensitive << ( reg_114 );
    ...
    sc_trace(mVcdFile, i_1_fu_124_p2, "i_1_fu_124_p2");
    ...
    sc_trace(mVcdFile, tmp_3_reg_185, "tmp_3_reg_185");
    sc_trace(mVcdFile, shift_reg_load_reg_195, "shift_reg_load_reg_195");
    sc_trace(mVcdFile, tmp_4_fu_140_p2, "tmp_4_fu_140_p2");
    sc_trace(mVcdFile, tmp_4_reg_200, "tmp_4_reg_200");
    sc_trace(mVcdFile, ap_CS_fsm_state4, "ap_CS_fsm_state4");
    sc_trace(mVcdFile, acc_1_fu_145_p2, "acc_1_fu_145_p2");
    sc_trace(mVcdFile, ap_CS_fsm_state5, "ap_CS_fsm_state5");
    sc_trace(mVcdFile, tmp_6_fu_150_p2, "tmp_6_fu_150_p2");
...
void fir::thread_ap_clk_no_reset_() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        acc_reg_91 = acc_1_fu_145_p2.read();
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        i_reg_103 = i_1_reg_175.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
                esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        i_reg_103 = ap_const_lv4_A;
    }
    if ((esl_seteq<1,1,1>(tmp_fu_118_p2.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
        i_1_reg_175 = i_1_fu_124_p2.read();
        tmp_3_reg_185 = tmp_3_fu_135_p1.read();
    }
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        shift_reg_load_reg_195 = shift_reg_q0.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        tmp_4_reg_200 = tmp_4_fu_140_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state7.read())) {
        tmp_6_reg_210 = tmp_6_fu_150_p2.read();
    }
}

void fir::thread_acc_1_fu_145_p2() {
    acc_1_fu_145_p2 = (!tmp_4_reg_200.read().is_01() || !acc_reg_91.read().is_01())? sc_lv<32>(): (sc_biguint<32>(tmp_4_reg_200.read()) + sc_biguint<32>(acc_reg_91.read()));
}
...
void fir::thread_c_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        if (esl_seteq<1,1,1>(tmp_fu_118_p2.read(), ap_const_lv1_1)) {
            c_address0 =  (sc_lv<4>) (ap_const_lv64_0);
        } else if (esl_seteq<1,1,1>(tmp_fu_118_p2.read(), ap_const_lv1_0)) {
            c_address0 =  (sc_lv<4>) (tmp_3_fu_135_p1.read());
        } else {
            c_address0 = "XXXX";
        }
    } else {
...
void fir::thread_c_ce0() {
    if (((esl_seteq<1,1,1>(tmp_fu_118_p2.read(), ap_const_lv1_0) && 
          esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) || 
         (esl_seteq<1,1,1>(tmp_fu_118_p2.read(), ap_const_lv1_1) && 
          esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())))) {
...
void fir::thread_i_1_fu_124_p2() {
    i_1_fu_124_p2 = (!i_reg_103.read().is_01() || !ap_const_lv4_F.is_01())? sc_lv<4>(): (sc_biguint<4>(i_reg_103.read()) + sc_bigint<4>(ap_const_lv4_F));
}
...
void fir::thread_shift_reg_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state7.read())) {
        ...
        shift_reg_address0 =  (sc_lv<4>) (tmp_3_reg_185.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        shift_reg_address0 =  (sc_lv<4>) (tmp_2_fu_130_p1.read());
    } else {
...
void fir::thread_tmp_2_fu_130_p1() {
    tmp_2_fu_130_p1 = esl_zext<64,4>(i_1_fu_124_p2.read());
}

void fir::thread_tmp_3_fu_135_p1() {
    tmp_3_fu_135_p1 = esl_zext<64,4>(i_reg_103.read());
}

void fir::thread_tmp_4_fu_140_p2() {
    tmp_4_fu_140_p2 = (!shift_reg_load_reg_195.read().is_01() || !reg_114.read().is_01())? sc_lv<32>(): sc_bigint<32>(shift_reg_load_reg_195.read()) * sc_bigint<32>(reg_114.read());
}

void fir::thread_tmp_6_fu_150_p1() {
    tmp_6_fu_150_p1 = x.read();
}

void fir::thread_tmp_6_fu_150_p2() {
    tmp_6_fu_150_p2 = (!reg_114.read().is_01() || !tmp_6_fu_150_p1.read().is_01())? sc_lv<32>(): sc_bigint<32>(reg_114.read()) * sc_bigint<32>(tmp_6_fu_150_p1.read());
}

void fir::thread_tmp_fu_118_p2() {
    tmp_fu_118_p2 = (!i_reg_103.read().is_01() || !ap_const_lv4_0.is_01())? sc_lv<1>(): sc_lv<1>(i_reg_103.read() == ap_const_lv4_0);
}

void fir::thread_y() {
    y = (!tmp_6_reg_210.read().is_01() || !acc_reg_91.read().is_01())? sc_lv<32>(): (sc_biguint<32>(tmp_6_reg_210.read()) + sc_biguint<32>(acc_reg_91.read()));
}
...
void fir::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(tmp_fu_118_p2.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
