...
#ifndef __matrix_vector_mulbkb__HH__
#define __matrix_vector_mulbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(matrix_vector_mulbkb) {
    ...
    SC_CTOR(matrix_vector_mulbkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
