...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    fir_mul_32s_32s_3bkb_U1 = new fir_mul_32s_32s_3bkb<1,5,32,32,32>("fir_mul_32s_32s_3bkb_U1");
    fir_mul_32s_32s_3bkb_U1->clk(ap_clk);
    fir_mul_32s_32s_3bkb_U1->reset(ap_rst);
    fir_mul_32s_32s_3bkb_U1->din0(c_load_reg_213);
    fir_mul_32s_32s_3bkb_U1->din1(data1_reg_116);
...
void fir::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
        tmp_6_reg_218 = grp_fu_164_p2.read();
    }
}
