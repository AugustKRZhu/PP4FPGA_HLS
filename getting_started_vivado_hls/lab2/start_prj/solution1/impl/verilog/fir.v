...
always @ (posedge ap_clk) begin
    if (((tmp_1_reg_189 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    if ((((tmp_1_reg_189 == 1'd0) & (1'b1 == ap_CS_fsm_state3)) | ((tmp_fu_137_p3 == 1'd0) & (tmp_1_fu_145_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2)))) begin
        shift_reg_we0 = 1'b1;
    end else begin
        shift_reg_we0 = 1'b0;
    end
...
assign acc_1_fu_169_p2 = (tmp_6_reg_218 + acc_reg_91);
...
assign c_address0 = tmp_5_fu_160_p1;

assign grp_fu_126_p2 = ($signed(grp_fu_126_p0) + $signed(5'd31));

assign i_cast_fu_133_p1 = i_reg_104;

assign tmp_1_fu_145_p2 = ((i_reg_104 == 5'd0) ? 1'b1 : 1'b0);

assign tmp_3_fu_151_p1 = grp_fu_126_p2;

assign tmp_4_fu_156_p1 = $unsigned(i_cast_reg_180);

assign tmp_5_fu_160_p1 = $unsigned(i_cast_reg_180);

assign tmp_6_fu_164_p2 = ($signed(c_load_reg_213) * $signed(data1_reg_116));

assign tmp_fu_137_p3 = i_reg_104[32'd4];
