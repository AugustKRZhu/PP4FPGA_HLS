...
architecture behav of fir is 
    ...
    "fir,hls_ip_2018_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xa7a12tcsg325-1q,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.470000,HLS_SYN_LAT=56,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=3,HLS_SYN_FF=241,HLS_SYN_LUT=208,HLS_VERSION=2018_2}";
    ...
    signal tmp_6_fu_164_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    tmp_6_fu_164_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(signed(c_load_reg_213) * signed(data1_reg_116))), 32));
