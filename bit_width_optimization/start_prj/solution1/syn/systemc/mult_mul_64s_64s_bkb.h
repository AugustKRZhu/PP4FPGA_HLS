...
#ifndef __mult_mul_64s_64s_bkb__HH__
#define __mult_mul_64s_64s_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mult_mul_64s_64s_bkb) {
    ...
    SC_CTOR(mult_mul_64s_64s_bkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
